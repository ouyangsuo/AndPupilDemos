...
import com.kitty.androidtest.upnpserver.MP3ContentDirectory;
import com.kitty.androidtest.upnpserver.SwitchPower;
...
public class LightActivity extends Activity implements PropertyChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// internal logging
		org.seamless.util.logging.LoggingUtil.resetRootHandler(new org.seamless.android.FixedAndroidLogHandler());
	...
	protected LocalDevice createDevice() throws ValidationException, LocalServiceBindingException {
		...
		LocalService service1 = new AnnotationLocalServiceBinder().read(SwitchPower.class);
		service1.setManager(new DefaultServiceManager<SwitchPower>(service1, SwitchPower.class));

		LocalService service2 = new AnnotationLocalServiceBinder().read(MP3ContentDirectory.class);
		service2.setManager(new DefaultServiceManager<MP3ContentDirectory>(service2, MP3ContentDirectory.class));

		LocalService<ConnectionManagerService> service3 = new AnnotationLocalServiceBinder().read(ConnectionManagerService.class);
		service3.setManager(new DefaultServiceManager<ConnectionManagerService>(service3, ConnectionManagerService.class));

		return new LocalDevice(new DeviceIdentity(udn), type, details, createDefaultDeviceIcon(), new LocalService[] { service1, service2, service3 });
	}

	// DOC:CREATE_DEVICE

	protected Icon createDefaultDeviceIcon() {
		return new Icon("image/png", 48, 48, 8, "icon.png", "89504E470D0A1A0A0000000D494844520000002D000000300803000000B28C03ED0000001974455874536F6674" + "776172650041646F626520496D616765526561647971C9653C00000300504C5445EEF2DBAAAAABF5F5" + "F5EEEEF2D1DDBABCC99DCBD2CBC5D0AB88888AFCFCFCD6E6B1CEDAB0BEC9A1F1F1F1F1F5DCDCEAB6D6" + "E2B6D9E4BAB5C78DEAEECCDAE5BCB3BA95D6E1B8DDEEB9C4CCBDB2B3B3CDD9BAE6EEC2F6F6F8D9EAAD" + "DBDDE2EEF3E1C4CEABA4A3A5CDD9AED1D1D1CDDDA9DDECB6D4E3B1DDEDB1656466FAFAFABCBCBCC9D9" + "A6D2DDB5D8E6B4CDDAC2D8E2B9D5DADB899A6BD9DADD9BA684DAEAB0D5E7AACBD6C4F8F8F8C6D2A7EA" + "EDD1CED3D0E8E8E9D4D7D9E6E6E6BFCD9ECAD6ADD5E7ADE2EEBDC6D5A2ECEFD59EA47DDBE9B6CFDCAD" + "ABB594DAECAF7B8D60D1DEC3A6AB81D6E2BEBBCE91B3C696C3C2C3C9C9CAC1CEA1E4E4E9D9E5B6D6E3"
				...
				+ "C91ADBEF146F29F657D4E048B6DEB88A13A7EA7F4739CDEB8C18398A5A8C6E047CE7D0AA49E235C7A7" + "5A93C95AD99FF100A36411E37749FF54EB8D9AF8541F61AA4B52F697BCC3C858A415906ACB2B73E41F" + "EE30F9C7B98AA9CE7691724D408D726A9235AF0C9A27317CA969CEC46B9B9494646BBD9169D511F496" + "04408001003EE42959E2CD74A60000000049454E44AE426082");
	}
	// DOC:CLASS_END
	// ...
}
