...
public class BrowserActivity extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		dialog.setButton(getString(R.string.OK), new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				Toast.makeText(BrowserActivity.this, deviceDisplay.getDevice().getType().getType(), Toast.LENGTH_SHORT).show();
				// 如果当前设备类型为BinaryLight，进入开关界面
				if (deviceDisplay.getDevice().getType().getType().equals("BinaryLight")) {
					initLightService(deviceDisplay.getDevice());
					BrowserActivity.this.startActivity(new Intent(BrowserActivity.this, LightControllerActivity.class));
				}
			}
		});
		dialog.show();
	...
	protected void initLightService(Device rootDevice) {
	...
	protected class BrowseRegistryListener extends DefaultRegistryListener {
		...
		public void remoteDeviceDiscoveryFailed(Registry registry, final RemoteDevice device, final Exception ex) {
			runOnUiThread(new Runnable() {
				public void run() {
					Toast.makeText(BrowserActivity.this, "Discovery failed of '" + device.getDisplayString() + "': " + (ex != null ? ex.toString() : "Couldn't retrieve device/service descriptors"), Toast.LENGTH_LONG).show();
				}
			});
